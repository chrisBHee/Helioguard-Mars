...
The system integrates with NASA's Surya AI platform to provide:
- Real-time solar activity measurements
- Predictive modeling for solar storm events
- Mars atmospheric condition monitoring
...
- Mock data generation for demonstration purposes when API is unavailable
